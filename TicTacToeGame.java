...
public class TicTacToeGame {
	...
	*/
	public TicTacToeGame(){
		...
		transformation = generateTransform();
	}
    ...
    *  the TicTacToeGame instance to be compared with this one
	...
	public boolean hasNext() {
		return nextTransform < transformation.length;
	}

	public void next() {
		Transformation t = transformation[nextTransform];
		if (t == Transformation.ID) {
			reset();
		}
		else if (t == Transformation.ROT) {
			Utils.rotate(lines, columns, transformedBoard);
		}
		else if (t == Transformation.HSYM) {
			Utils.horizontalFlip(lines, columns, transformedBoard);
		}
		else if (t == Transformation.VSYM) {
    ...
    *  String representation of the game
	...
	private Transformation[] generateTransform() {
		if (lines == columns) {
			return new Transformation[] {Transformation.ID,
													Transformation.ROT, Transformation.ROT,
													Transformation.ROT, Transformation.HSYM,
													Transformation.ROT, Transformation.ROT,
													Transformation.ROT};
		} else {
			return new Transformation[] {Transformation.ID, Transformation.HSYM,
